...
public class HW2 {
    public static void main(String[] args) {
        ...
        temperature. Your program should check if temperature is below 32 then it should print “Water will freeze
        with temperature ”,
        ...
        if (temperature<32) {
            ...
            System.out.println("Water will not freeze wit temperature");
        }
    }
}
